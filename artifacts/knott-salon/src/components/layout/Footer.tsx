    ...
    <footer className="footer-gradient border-t border-white/5 pt-14 pb-6 hidden md:block">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            <Link href="/" className="inline-block mb-8 group" data-testid="link-footer-logo">
              <div className="flex flex-col justify-center">
                <span 
                  className="block text-[3rem] md:text-[3.6rem] leading-none tracking-normal gradient-heading pt-3 pb-1 pl-2 pr-4 text-glow transition-transform duration-500 group-hover:scale-105 origin-left"
                  style={{ fontFamily: 'Great Vibes, cursive', fontWeight: 700 }}
                >
                  Knott
                </span>
                <span className="block font-serif text-[8.5px] md:text-[10px] tracking-[0.3em] font-medium text-white/50 uppercase ml-3 mt-1">
